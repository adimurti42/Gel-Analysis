...
bashpip install numpy scipy matplotlib tifffile scikit-image

Usage

Open surf7c.py and set the filename variable to point at your .tif z-stack.
Adjust the physical parameters to match your microscope setup:
...
Optionally tweak the reconstruction parameters:
